...
/**
 * Единый словарь ключей frontmatter.
 *
 * Зачем:
 * - убрать “магические строки” по проекту
 * - стабилизировать схему YAML (vault) и упростить рефакторинг
 */
...
export const FM = {
  ...
  // -----------------------------------------------------------------------------
  // IDs (явные, чтобы в “единой БД” не путались идентификаторы разных сущностей)
  // -----------------------------------------------------------------------------

  // meeting/event note ids
  eventId: "event_id",
