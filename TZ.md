...
- [ ] Запись звука через [gst-kit](https://github.com/repugraf/gst-kit)
  ...
  - [ ] Проверить что удалены политики связанные с ffmpeg и их тесты. Поискать мертвый код.
  - [x] Добавляем в настройки g_streamer (GStreamer) добавляем проверку зависимостей
  - [x] Обновить документаци про зависимости, в целом можно взять от сюда https://github.com/repugraf/gst-kit
  ...
  - [ ] Добавляем бэкенд для gst, в диалог передаем два уровня громкости, микрофона и монитора (Есть прототип scripts/gst-stand.cjs)
  - [ ] gst-kit Делаем общий слой, подключение библиотеки, определение устройств, функции и т.д. Что бы реиспользовать в Диктофоне и настройках.
  - [ ] Пишем файл не в tmp а сразу в нужное место и с нужным именем (Касается и Electron Media Devices)
