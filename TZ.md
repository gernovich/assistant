...
[x] Юнит тесты
[x] Ревью
[ ] Логирование, установить необходимые сообщения и удалить лишние. Основная задача что если что то пошло не так можно было быстро сориентироваться где проблемаe и уже точежно залогировать.
[ ] Ручное тестирование
[ ] Актууализировать всю документацию
