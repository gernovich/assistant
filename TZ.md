...
- [ ] В диктофоне нужно текущее время, сколько прошло, сколько осталось встречи.
- [ ] В диктофоне при авто старте нужна кнопка остановить обратный отсчет.
