...
- [ ] Протоколы точно а может быть и другие сущности лучше раскладывать по папкам, например протоколы по папкам с именм встречи, а протоколы без встречи ложить в корень.
...
[ ] Ревью всего проекта и особенно записи звука, поиск точек улучшения
[ ] Ревакторин
