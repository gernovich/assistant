...
- [+] Название встречи — человеческое; при изменении summary/конфликтах сохраняем стабильность через `[sid]` и делаем безопасный rename (суффиксы/конфликты не ломают связь)
...
- [ ] Файлы с записями складываем в Ассистент/Записи
